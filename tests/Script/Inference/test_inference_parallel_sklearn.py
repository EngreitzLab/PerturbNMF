"""
End-to-end smoke test for parallel K inference mode (sk-cNMF).
...
This test validates:
  1. Per-K factorization produces spectra files
...
OUTPUT_DIR = str(PERSISTENT_OUTPUT / "sk-cNMF-parallel")


# ---------- tests ----------

class TestSkCNMFParallel:
    """Test parallel K factorization and merge."""

    def test_01_prepare_and_factorize_per_k(self, mini_h5ad_path):
        """Run prepare + factorize separately for each K (simulates parallel SLURM jobs)."""
