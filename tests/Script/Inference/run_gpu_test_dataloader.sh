...
#SBATCH --job-name=test_torch_dataloader
#SBATCH --output=tests/output/torch-cNMF/dataloader/Inference/logs/slurm_%j.out
#SBATCH --error=tests/output/torch-cNMF/dataloader/Inference/logs/slurm_%j.err
...
LOG_DIR="tests/output/torch-cNMF/dataloader/Inference/logs"
mkdir -p "$LOG_DIR"

eval "$(conda shell.bash hook)"
conda activate torch-nmf-dl

echo "=== torch-cNMF dataloader mode test ==="
echo "Node: $(hostname)"
...
echo ""
echo "=== dataloader mode test done ==="
