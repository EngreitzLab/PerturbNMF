...
#SBATCH --output=tests/output/torch-cNMF/dataloader/Calibration/logs/slurm_crt_%j.out
#SBATCH --error=tests/output/torch-cNMF/dataloader/Calibration/logs/slurm_crt_%j.err
...
python -m pytest tests/Script/Calibration/test_calibration.py::TestCRTReformat -v --tb=short 2>&1 | tee "${LOG_DIR}/test_crt.out"
